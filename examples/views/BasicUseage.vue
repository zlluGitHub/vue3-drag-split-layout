...
function loadInnerLayout() {
  if (splitLayout.value) {
    ...
    splitRight.addPanel({
      ...
      tooltip: 'F:\\Programming\\WebProjects\\vue3-drag-split-layout\\examples\\views\\BasicUseage.vue',
      name: 'file1',
      iconSmall: () => h(IconVue),
      data: { value: TestContent1, language: 'vue', path: 'F:\\Programming\\WebProjects\\vue3-drag-split-layout\\examples\\views\\BasicUseage.vue', },
    });
    splitLeft.addPanel({
      title: 'CodeLayoutHelp.md',
      tooltip: 'F:\\Programming\\WebProjects\\vue3-drag-split-layout\\CodeLayoutHelp.md',
      name: 'file2',
      data: { value: TestContent2, language: 'markdown', path: 'F:\\Programming\\WebProjects\\vue3-drag-split-layout\\CodeLayoutHelp.md', },
      closeType: 'close',
