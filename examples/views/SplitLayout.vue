  ...
  <div class="full-container demo">
    <SplitLayout ref="splitLayoutRef" @panelClose="onPanelClose" @panelDrop="onPanelDrop" @canLoadLayout="loadLayout"
      ...
      <template #tabContentRender="{ panel }">
        ...
        <h2 v-else :style="{ backgroundColor: colors[panel.data] }">Grid {{ panel.name }} {{ (panel.parentGroup as
          CodeLayoutSplitNGridInternal).direction }}</h2>
      </template>
...
import type { CodeLayoutSplitNGridInternal, CodeLayoutSplitNInstance } from 'vue3-drag-split-layout';
